      ...
      <div className="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8">
        <div className="grid gap-8 sm:grid-cols-2 lg:grid-cols-4">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-muted">
              ...
              <li><Link href="/virtual-tour" className="transition-colors hover:text-heading">Virtual Tour</Link></li>
        ...
        <div className="mt-10 border-t border-line pt-6 flex flex-col items-center gap-4">
          <div className="flex gap-5">
            <a href="https://instagram.com/gbhotelandsuite" target="_blank" rel="noopener noreferrer" aria-label="Instagram" className="text-muted transition-colors hover:text-heading">
            ...
            <a href="https://wa.me/2348062438856" target="_blank" rel="noopener noreferrer" aria-label="WhatsApp" className="text-muted transition-colors hover:text-heading">
            ...
            <a href="https://tiktok.com/@gbhotelandsuite" target="_blank" rel="noopener noreferrer" aria-label="TikTok" className="text-muted transition-colors hover:text-heading">
            ...
            <a href="https://x.com/GBHotelandSuite" target="_blank" rel="noopener noreferrer" aria-label="X (Twitter)" className="text-muted transition-colors hover:text-heading">
